...
public class Ex06_Calender {
	public static void main(String[] args) {
		...
		System.out.println(now.get(Calendar.MONTH)+ 1 + "월"); // 자바에선 month 0~ 11까지임
		System.out.println(now.get(Calendar.DATE) + "일");
		System.out.println(now.get(Calendar.DAY_OF_MONTH) + "일");
		System.out.println(now.get(Calendar.HOUR) + "시");  // 12시간제(오전, 오후 필요)
