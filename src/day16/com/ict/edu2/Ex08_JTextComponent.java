...
public class Ex08_JTextComponent extends JFrame{
	public Ex08_JTextComponent() {
		...
		JScrollPane jsp = new JScrollPane( jta,
				//ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, //세로스크롤바
				ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS, //세로스크롤바 첨부터 항상
		...
		jp.add(jtf2);
		jp.add(jLabe3);
		jp.add(jsp);   // <-jta가 아닌 스크롤 기능 까지 포함된 jsp과 와야함
