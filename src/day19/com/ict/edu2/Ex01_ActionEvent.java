...
//			   포함되어 있는 메서드(추상메서드)
//			   즉 발생된 이벤트 객체를 받아서 실질적으로 처리해주는 기능을 하는 메서드

// ActionEvent : 컴포넌트를 눌렀거나, 선택되었을때, Enter를 눌렀을 때 발생하는 이벤트
...
public class Ex01_ActionEvent extends JFrame implements ActionListener{
	JPanel jp;
	JButton jb1 ,jb2, jb3 ;   // 전역변수로 빼줘야 리스너 할떄 사용 가능
	public Ex01_ActionEvent() {
		...
		jb1.addActionListener(this);  // 첫번째 방법 this
		jb2.addActionListener(this);  // 버튼누르면  -> 여기서 실행actionPerformed(){}
