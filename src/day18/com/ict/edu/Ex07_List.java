...
public class Ex07_List {
	...
	public static void main(String[] args) {
		...
		// 검색 : search(), elementAt(), firstElement(), lastElement() :  list없음
		...
		if (list.contains("손흥민")) {
			...
			// 치환
		//	list.set(list.lastIndexOf("손흥민"), "박지성");  // set(위치값,바꿀내용)
		...
		if (vector.contains("손흥민")) {
			...
			// 치환
			vector.set(vector.lastIndexOf("손흥민"), "차두리");  // set(위치값,바꿀내용)
