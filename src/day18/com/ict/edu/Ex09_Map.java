...
public class Ex09_Map {
	...
	public static void main(String[] args) {
		...
		map1.put(1, "미국");
		map1.put(2, "영국");
		// 순서대로 안해도 된다(본인이 편할라면 순서대로)
		map1.put(8, "태국");
		map1.put(10, "중국");
		map1.put(5, "남아프리카공화국");
		System.out.println(map1);
		
		map1.put(10, "대만");//기존 value가 삭제된다.(덮어쓰기)
		System.out.println(map1);
		...
		while (it.hasNext()) {
			...
			System.out.println(k + ":" + map1.get(k));  // 보통 이렇게 많이 씀
		}
		
		
		// entrSet() 메서드는 key, value의 값이 모두 필요한 경우 사용
