...
public class Ex02_Set {
	public static void main(String[] args) {
		...
		// 형식 : TreeSet<제네릭타입=객체타입=클래스> 참조변수 = new TreeSet<[제네릭타입=객체타입=클래스]>();
		...
		h1.add(20);  // 오토박싱 : 기본자료형이 해당 객체로 자동으로 만들어진다.
		...
		h2.add(38.2);
		//h2.add(30);  //제네릭타입을 맞춰야한다 <= 프로모션이 안됨    30.0 
		...
		h3.add('a');
		h3.add('v');
		h3.add('a'); // 중복안됨, 들어가지 않음
		
		System.out.println(h3);
		System.out.println();
		
		
		System.out.println("하나씩 처리하기 (개선된 for문)"); // 일반 for문 사용 불가 
		for (Integer k : h1) {   // foreach
