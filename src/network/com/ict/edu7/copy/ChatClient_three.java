...
public class ChatClient_three extends JFrame implements Runnable{
	...
	public ChatClient_three() {
		...
		img.setIcon(new ImageIcon(ChatClient_three.class.getResource("/images/chat.PNG")));
