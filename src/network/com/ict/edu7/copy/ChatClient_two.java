...
public class ChatClient_two extends JFrame implements Runnable{
	...
	public ChatClient_two() {
		...
		img.setIcon(new ImageIcon(ChatClient_two.class.getResource("/images/chat.PNG")));
