...
// XML 파싱 : XML 로 구성된 데이터를 원하는 데이터만 추출, 가공하는 것
// DOM(Docoment Object Modeling) 방식 : 웹 브라우저가 태그를 해석하고 표현하는 방식
public class Ex04 {
	public static void main(String[] args) {
		...
		// 파일 쓰기
		String pathname = "D:"+File.separator+"KJH"+File.separator+"오늘날씨.txt";
