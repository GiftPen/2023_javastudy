...
public class Ex01 {
	public static void main(String[] args) {
		...
		List<VO> list = null;
		switch (menu) {
		case 1: list = DAO.getList();test.prn(list); break; // static이라 바로 접근가능
		case 2:
